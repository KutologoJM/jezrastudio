"""
Django settings for jezrastudio project.
...
# Project root urls
ROOT_URLCONF = 'jezrastudio.urls'

# WSGI
WSGI_APPLICATION = 'jezrastudio.wsgi.application'
...
# Site Admins
ADMINS = [
    ("Site Owner", "jezrastudio-admin@jezrastudio.online")
]
